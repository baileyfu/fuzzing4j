...
public class Constants {
    ...
    public static final String ENV_CORE_LOG_DEBUG_ON = "fuzzing4j.core.log.debugOn";
    /**
     * 单个方法出错中断整个进程
     */
